...
See the dedicated [Code Signing & Notarization](code-signing.md) guide for the full walkthrough — certificate creation, `.p12` export, GitHub Secrets setup, and troubleshooting.
