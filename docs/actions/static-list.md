...
The command YAML references the list file by name (without the `.tsv` extension), or uses the `shared:` prefix for shared lists (see [Shared scripts and lists](../guides/writing-scripts.md#shared-scripts-and-lists)):
